            ...
            <div class="col-md-5 col-sm-5 hidden-xs left-col eq-height-col" >
                ...
                <div class="left-col-content login-header">
                    <div class="logo-div-1">
                        <img src="http://pos.360logos.co.uk/hareer-logo-2.png">
                    ...
                    @if(!empty(config('constants.app_title')))
                        <small style="color:#b48f44">{{config('constants.app_title')}}</small>
                    @endif
                    </div>
                ...
                <div class="col-md-9 col-xs-8" style="text-align: right;padding-top: 10px;">
                    @if(!($request->segment(1) == 'business' && $request->segment(2) == 'register'))
                        ...
                        @if(config('constants.allow_registration'))
                            <a style="background-color:#b48f44; color:white" href="{{ route('business.getRegister') }}@if(!empty(request()->lang)){{'?lang=' . request()->lang}} @endif" class="btn  btn-flat" ><b>{{ __('business.not_yet_registered')}}</b> {{ __('business.register_now') }}</a>
                            <!-- pricing url -->
